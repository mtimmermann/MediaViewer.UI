define(function(require, exports, module) {
    ...
    var SearchResultsTemplate = require('tpl!templates/videos_search/search_results.jst'),
        SearchResultItemView = require('views/videos_search/SearchResultItem');
    ...
    return Backbone.View.extend({
        ...
        render: function() {
            ...
            _.each(this.collection.models, function (model) {
                this.$el.append(new SearchResultItemView({model:model}).render().el);
            }, this);
            return this;
        }
    });
